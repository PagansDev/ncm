...
useHead({
    ...
    meta: [
        { name: 'description', content: 'Tabela Fiscal - NCM' },
                        ...
                        <div class="space-y-6 p-6">
                            <div class="space-y-4">
                                <div class="flex items-start space-x-3">
                                    ...
                                    <div>
                                        ...
                                        <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">
                                            Digite o código NCM ou parte da descrição do produto. A busca funciona com
                                            acentos e
                                ...
                                <div class="flex items-start space-x-3">
                                    ...
                                    <div>
                                        <h4 class="text-sm font-medium text-gray-900 dark:text-white">Organização por
                                            Categorias</h4>
                                        <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">
                                            <strong>Grupos principais:</strong> Categorias amplas como "Animais
                                            vivos"<br>
                                ...
                                <div class="flex items-start space-x-3">
                                    ...
                                    <div>
                                        ...
                                        <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">
                                            Clique no ícone ao lado do código para copiá-lo automaticamente para usar em
                                            outros lugares.
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div class="flex items-start space-x-3">
                                    ...
                                    <div>
                                        <h4 class="text-sm font-medium text-gray-900 dark:text-white">Carregamento
                                            Rápido</h4>
                                        <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">
                                            As informações são salvas no seu navegador para carregar mais rápido nas
                                            próximas vezes.
                                        </p>
                                    </div>
                                </div>
                            ...
                            <div class="flex justify-end pt-2">
                                <UButton color="secondary" variant="ghost" class="cursor-pointer"
                                    @click="modalOpen = false">Entendi, começar a usar</UButton>
                            </div>
                        </div>
                    </template>
                </UModal>
